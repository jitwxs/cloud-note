...
var S = {
    init: function () {
        ...
        if (i !== -1) {
            ...
            S.UI.simulate('Hello|Welcome to|WuDao|CloudNote|Designed by|Team Four'); //模拟屏幕显示
        }

        S.Drawing.loop(function () {
            S.Shape.render();   //渲染  vue.js里的render()函数
        });
    }
};
...
S.Drawing = (function () {
    ...
    return {
        init: function (el) {
            canvas = document.querySelector(el);  //返回文档中指定的css选择器的元素
